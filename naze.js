...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `919497206865@s.whatsapp.net`
let dana = `919497206865@s.whatsapp.net`
let shopeeotp = `919497206865@s.whatsapp.net`
let shopee = `919497206865@s.whatsapp.net`
let tokopedia = `919497206865@s.whatsapp.net`
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `*Bot by Toxic Leo* 
...
├ *𝙼𝚘𝚍𝚎* : ${naze.public ? 'Public' : `Self`}
├ *𝙿𝚛𝚎𝚏𝚒𝚡* :「 MULTI-PREFIX 」
├ *𝚃𝚘𝚝𝚊𝚕 𝙷𝚒𝚝* : ${jumlahcmd}
├ *𝚃𝚘𝚝𝚊𝚕 𝙷𝚒𝚝 𝚃𝚘𝚍𝚊𝚢* : ${jumlahharian}
╰──❍`
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           title: ' » Bot Rental?  –––––––·•',
 rows: [
 {title: "〽️ • Rent", rowId: `donation`, description: `CLICK TO RENT BOT`},
                 {title: "📴 • Owner", rowId: `owner`, description: `CLICK TO ASK THE OWNER`}
 ]
                 },{
                 title: "⚠︎ » CHANGE MENU BOT « ",
                 rows: [
                 {title: "✦ Group ", rowId: `mgroup`, description: `╰ Create Group Feature, But Be Careful Admin :v`},
                 {title: "✦ Webzone ", rowId: `mwebzone`, description: `╰ Search Movies?  Here's the Place `},
                 {title: "✦ Downloader ", rowId: `mdownloader`, description: `╰ Create Download What?  `},
                 {title: "✦ Search ", rowId: `msearch`, description: `╰ Search What Hi`},
                 {title: "✦ Random ", rowId: `mrandom`, description: `╰ Random Moment🗿`},
                 {title: "✦ Text Pro ", rowId: `mtextpro`, description: `╰ The text is cool, isn't it?`},
                 {title: "✦ Photo Oxy ", rowId: `mphotooxy`, description: `╰ ️Amat Gabut`},
                 {title: "✦ Ephoto ", rowId: `mephoto`, description: `╰ Edit What?`},
                 {title: "✦ Fun ", rowId: `mfun`, description: `╰ Create Fun² Bro`},
                 {title: "✦ Primbon ", rowId: `mprimbon`, description: `╰ 😂Laughs`},
                 {title: "✦ Convert ", rowId: `mconvert`, description: `╰ What do you want to do?`},
                 {title: "✦ Main ", rowId: `mmain`, description: `╰ Weapons Admin & Owner`},
                 {title: "✦ Database ", rowId: `mdatabase`, description: `╰ Nothing Here`},
                 {title: "✦ Anonymous ", rowId: `manonymous`, description: `╰ Secret Feature Don't Use !`},
                 {title: "✦ Islamic ", rowId: `mislamic`, description: `╰ Mashaallah Brother`},
                 {title: "✦ Voice ", rowId: `mvoice`, description: `╰ What Song Req?`},
                 {title: "✦ Owner ", rowId: `mowner`, description: `╰ Do Not Disturb My Owner😡`}
                 ]
                },{
	           title: ' ∫ » SUPPORT ME –––––––·•',
	           rows: [
...
│
x . ${prefix}linkgroup
x . ${prefix}ephemeral [option]
x . ${prefix}setppgc [image]
x . ${prefix}setname [text]
x . ${prefix}setdesc [text]
x . ${prefix}group [option]
x . ${prefix}editinfo [option]
x . ${prefix}add @user
x . ${prefix}kick @user
x . ${prefix}hidetag [text]
x . ${prefix}tagall [text]
x . ${prefix}antilink [on/off]
x . ${prefix}mute [on/off]
x . ${prefix}promote @user
x . ${prefix}demote @user
x . ${prefix}vote [text]
x . ${prefix}devote
x . ${prefix}upvote
x . ${prefix}cekvote
...
x . ${prefix}playstore
x . ${prefix}gsmarena
x . ${prefix}jadwalbioskop
x . ${prefix}nowplayingbioskop
x . ${prefix}aminio
x . ${prefix}wattpad
x . ${prefix}webtoons
x . ${prefix}drakor
...
x . ${prefix}tiktoknowm [url]
x . ${prefix}tiktokwm [url]
x . ${prefix}tiktokmp3 [url]
x . ${prefix}instagram [url]
x . ${prefix}twitter [url]
x . ${prefix}twittermp3 [url]
x . ${prefix}facebook [url]
x . ${prefix}pinterestdl [url]
x . ${prefix}ytmp3 [url]
x . ${prefix}ytmp4 [url]
x . ${prefix}getmusic [query]
x . ${prefix}getvideo [query]
x . ${prefix}umma [url]
x . ${prefix}joox [query]
x . ${prefix}soundcloud [url]
...
x . ${prefix}play [query]
x . ${prefix}yts [query]
x . ${prefix}google [query]
x . ${prefix}gimage [query]
x . ${prefix}pinterest [query]
x . ${prefix}wallpaper [query]
x . ${prefix}wikimedia [query]
x . ${prefix}ytsearch [query]
x . ${prefix}ringtone [query]
x . ${prefix}stalk [option] [query]
...
x . ${prefix}3dchristmas
x . ${prefix}3ddeepsea
x . ${prefix}americanflag
x . ${prefix}3dscifi
x . ${prefix}3drainbow
x . ${prefix}3dwaterpipe
x . ${prefix}halloweenskeleton
x . ${prefix}sketch
x . ${prefix}bluecircuit
x . ${prefix}space
x . ${prefix}metallic
x . ${prefix}fiction
x . ${prefix}greenhorror
x . ${prefix}transformer
x . ${prefix}berry
x . ${prefix}thunder
x . ${prefix}magma
x . ${prefix}3dcrackedstone
x . ${prefix}3dneonlight
x . ${prefix}impressiveglitch
x . ${prefix}naturalleaves
x . ${prefix}fireworksparkle
x . ${prefix}matrix
x . ${prefix}dropwater
x . ${prefix}harrypotter
x . ${prefix}foggywindow
x . ${prefix}neondevils
x . ${prefix}christmasholiday
x . ${prefix}3dgradient
x . ${prefix}blackpink
x . ${prefix}gluetext
...
x . ${prefix}beach
x . ${prefix}blackpink
x . ${prefix}igcertificate
x . ${prefix}ytcertificate
...
x . ${prefix}tictactoe
x . ${prefix}family100
x . ${prefix}tebak [option]
x . ${prefix}math [mode]
x . ${prefix}suitpvp [@tag]
...
x . ${prefix}artinama
x . ${prefix}ramaljodoh
x . ${prefix}ramaljodohbali
x . ${prefix}suamiistri
x . ${prefix}ramalcinta
x . ${prefix}cocoknama
x . ${prefix}pasangan
x . ${prefix}jadiannikah
x . ${prefix}sifatusaha
x . ${prefix}rezeki
x . ${prefix}pekerjaan
x . ${prefix}nasib
...
x . ${prefix}nagahari
x . ${prefix}arahrezeki
x . ${prefix}peruntungan
x . ${prefix}weton
x . ${prefix}karakter
x . ${prefix}keberuntungan
x . ${prefix}memancing
x . ${prefix}masasubur
x . ${prefix}zodiak
...
x . ${prefix}owner
x . ${prefix}report
x . ${prefix}menu / ${prefix}help / ${prefix}?
x . ${prefix}delete
x . ${prefix}infochat
x . ${prefix}quoted
x . ${prefix}listpc
...
x . ${prefix}speedtest
x . ${prefix}menfes
x . ${prefix}tinyurl [link]
x . ${prefix}linkpoi [link]
...
x . ${prefix}react [emoji]
x . ${prefix}chat [option]
x . ${prefix}join [link]
x . ${prefix}leave
x . ${prefix}block @user
x . ${prefix}unblock @user
x . ${prefix}bcgroup [text]
x . ${prefix}bcall [text]
x . ${prefix}setppbot [image]
x . ${prefix}setexif
x . ${prefix}setmenu [option]
...
x . ${prefix}speedtest
x . ${prefix}menfes 
x . ${prefix}tinyurl [url]
x . ${prefix}shrturl [url]
